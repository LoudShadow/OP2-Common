...
//       // m_y.resize(numNode);
//       // m_z.resize(numNode);
//       m_x = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_y = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_z = (Real_t*) malloc(numNode * sizeof(Real_t));

//       // m_xd.resize(numNode); // velocities
//       // m_yd.resize(numNode);
//       // m_zd.resize(numNode);
//       m_xd = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_yd = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_zd = (Real_t*) malloc(numNode * sizeof(Real_t));

//       // m_xdd.resize(numNode); // accelerations
//       // m_ydd.resize(numNode);
//       // m_zdd.resize(numNode);
//       m_xdd = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_ydd = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_zdd = (Real_t*) malloc(numNode * sizeof(Real_t));

//       // m_fx.resize(numNode);  // forces
//       // m_fy.resize(numNode);
//       // m_fz.resize(numNode);
//       m_fx = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_fy = (Real_t*) malloc(numNode * sizeof(Real_t));
//       m_fz = (Real_t*) malloc(numNode * sizeof(Real_t));

//       // m_nodalMass.resize(numNode);  // mass
//       m_nodalMass = (Real_t*) malloc(numNode * sizeof(Real_t));  // mass
...
//       m_nodelist = (Index_t*) malloc(numElem*8 * sizeof(Index_t));
...
//       m_lxim = (Index_t*) malloc(numElem * sizeof(Index_t));
//       m_lxip = (Index_t*) malloc(numElem * sizeof(Index_t));
//       m_letam = (Index_t*) malloc(numElem * sizeof(Index_t));
//       m_letap = (Index_t*) malloc(numElem * sizeof(Index_t));
//       m_lzetam = (Index_t*) malloc(numElem * sizeof(Index_t));
//       m_lzetap = (Index_t*) malloc(numElem * sizeof(Index_t));

//       // m_elemBC.resize(numElem);
//       m_elemBC = (Int_t*) malloc(numElem * sizeof(Int_t));


//       // m_e.resize(numElem);
//       // m_p.resize(numElem);
//       m_e = (Real_t*) malloc(numElem * sizeof(Real_t));
//       m_p = (Real_t*) malloc(numElem * sizeof(Real_t));


//       // m_q.resize(numElem);
//       // m_ql.resize(numElem);
//       // m_qq.resize(numElem);
//       m_q = (Real_t*) malloc(numElem * sizeof(Real_t));
//       m_ql = (Real_t*) malloc(numElem * sizeof(Real_t));
//       m_qq = (Real_t*) malloc(numElem * sizeof(Real_t));

//       // m_v.resize(numElem);
//       m_v = (Real_t*) malloc(numElem * sizeof(Real_t));

//       // m_volo.resize(numElem);
//       // m_delv.resize(numElem);
//       // m_vdov.resize(numElem);
//       m_volo = (Real_t*) malloc(numElem * sizeof(Real_t));
//       m_delv = (Real_t*) malloc(numElem * sizeof(Real_t));
//       m_vdov = (Real_t*) malloc(numElem * sizeof(Real_t));

//       // m_arealg.resize(numElem);
//       m_arealg = (Real_t*) malloc(numElem * sizeof(Real_t));

//       // m_ss.resize(numElem);
//       m_ss = (Real_t*) malloc(numElem * sizeof(Real_t));

//       // m_elemMass.resize(numElem);
//       m_elemMass = (Real_t*) malloc(numElem * sizeof(Real_t));

//       // m_vnew.resize(numElem) ;
//       m_vnew = (Real_t*) malloc(numElem * sizeof(Real_t));
//    }
...
//    bool symmXempty()          { return 0; }
//    bool symmYempty()          { return 0; }
//    bool symmZempty()          { return 0; }
...
//    Real_t* m_symmX;              /* symmetry plane nodesets */
//    Real_t* m_symmY;
//    Real_t* m_symmZ;
